...
/***/ "./resources/js/affiliate/affiliate.js":
/*!*********************************************!*\
  !*** ./resources/js/affiliate/affiliate.js ***!
  \*********************************************/
/*! no exports provided */
...
var Finist = /*#__PURE__*/function () {
  function Finist() {
    var _this = this;

    _classCallCheck(this, Finist);

    // Кнопка "Наверх"
    this.scrollTop = document.querySelector('.js-scroll-top');
    this.scrollTop.addEventListener('click', this.goUp.bind(this)); // Мобильное меню

    this.burger = document.querySelector('.js-burger');
    this.mobileMenu = document.querySelector('.js-mobile-menu');
    this.burger.addEventListener('click', this.toggleMenu.bind(this)); // Десктопное меню

    this.dropdownList = _toConsumableArray(document.querySelectorAll('.js-dropdown-list'));
    this.dropdownMenuItem = _toConsumableArray(document.querySelectorAll('.js-dropdown-item')); // Слайдер с картами

    new _glidejs_glide__WEBPACK_IMPORTED_MODULE_0__["default"]('.glide').mount();

    if (document.querySelector('.js-show-section')) {
      this.hiddenSections = _toConsumableArray(document.querySelectorAll('.js-hidden-section'));
    ...
    this.closeBtn = _toConsumableArray(document.querySelectorAll('.js-contacts-close'));
    ...
    this.dropdownMenuItem.forEach(function (item) {
      return item.addEventListener('click', _this.showDropdown.bind(_this));
  ...
  _createClass(Finist, [{
    ...
    value: function showSections() {
      ...
      this.hiddenSections.forEach(function (section) {
...
/***/ 2:
/*!***************************************************!*\
  !*** multi ./resources/js/affiliate/affiliate.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! c:\Users\gerratresher\Documents\date\OpenServer\domains\fw\resources\js\affiliate\affiliate.js */"./resources/js/affiliate/affiliate.js");
