...
class JobSpecialPropertyBlocksSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        if(Schema::hasTable('block_items')) {
            ...
            $blocks = [
                [   'name' => 'Вакансии (cпециалист по сопровождению (имущество))',
                    'slug' => 'job-special-property',
                    'type' => 'template',
                    'model_id' => 'blockcrud.templates.job.special_property',
                    'created_at' => $date,
                    'updated_at' => $date,
                ],
            ];
