...
class JobSpecialMotorBlocksSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        if(Schema::hasTable('block_items')) {
            ...
            $blocks = [
                [   'name' => 'Вакансии (cпециалист по сопровождению (моторные виды))',
                    'slug' => 'job-special-motor',
                    'type' => 'template',
                    'model_id' => 'blockcrud.templates.job.special_motor',
                    'created_at' => $date,
                    'updated_at' => $date,
                ],
            ];
