...
class CorpInsuranceResponsibilityBlocksSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        if(Schema::hasTable('block_items')) {
            ...
            $blocks = [
                [   'name' => 'Страхование ответственности юридических лиц',
                    'slug' => 'corporate-insurance-responsibility',
                    'type' => 'template',
                    'model_id' => 'blockcrud.templates.corpinsurance.responsibility',
                    'created_at' => $date,
                    'updated_at' => $date,
                ],
            ];
