        ...
        if(Schema::hasTable('block_items')) {
            ...
            $blocks = [
                ...
                [
                    ...
                    'slug' => 'plus-minus',
                    'type' => 'template',
                    'model_id' => 'blockcrud.templates.kis.plus_minus',
                    'created_at' => $date,
                    'updated_at' => $date,
                ],
                [
                    ...
                    'slug' => 'kis-desc',
                    'type' => 'template',
                    'model_id' => 'blockcrud.templates.kis.desc',
                    'created_at' => $date,
                    'updated_at' => $date,
                ],
                [
                    ...
                    'slug' => 'kis-insurance',
                    'type' => 'template',
                    'model_id' => 'blockcrud.templates.kis.insurance',
                    'created_at' => $date,
                    'updated_at' => $date,
                ],
                [
                    ...
                    'slug' => 'kis-best-price',
                    'type' => 'template',
                    'model_id' => 'blockcrud.templates.kis.best_price',
                    'created_at' => $date,
                    'updated_at' => $date,
                ],
                [
