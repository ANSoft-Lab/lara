<section class="contacts contacts--cp glide">
    ...
    <div class="js-map-slider contacts__slider glide__track" data-glide-el="track">
        <div class="contacts__wrapper glide__slides">
            ...
            <div class="contacts__map contacts__map--cp js-map glide__slide">
                ...
                <div class="contacts__map-info">
                    <h3>Рязань</h3>
                    <p><b>Адрес:</b> г. Рязань ул. Маяковского д. 1а корп. Е БЦ "Капитал-Атрон"</p>
                    <p><b>Телефон:</b> +7 (4912) 434-107</p>
                    <p><b>График работы:</b> Пн-Пт: 9:00-19:00</p>
                </div>
            </div>
            <div class="contacts__map contacts__map--cp js-map glide__slide">
                ...
                <div class="contacts__map-info">
                    <h3>Воронеж</h3>
                    <p><b>Адрес:</b> г. Воронеж, ул. Платонова, дом 25</p>
