<section class="affiliate-banner">
    <h2 class="affiliate-banner__title">Партнёрская программа для риэлторов</h2>
    <p class="affiliate-banner__desc">
        Зарабатывайте дополнительные <span style="font-weight:bold;background:#F2CB4D;padding:3px 5px;">20&nbsp;000&nbsp;—&nbsp;50&nbsp;000&nbsp;рублей</span> с&nbsp;каждого ипотечного клиента!
    </p>
    <p class="affiliate-banner__desc">
    ...
    <div>
        @include('blockcrud.modals.feedback', ['modal_title' => 'Стать партнёром', 'link' => false, 'btn_class' => 'modal__btn'])
    </div>
</section>
