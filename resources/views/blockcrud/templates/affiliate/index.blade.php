...
<section class="banner">
    <div class="container">
        ...
        <div class="banner__bottom">
            <div class="banner__left">Получить бесплатную поддержку от брокера</div>
            <div class="banner__right">
                <a class="banner__social banner__social_telegram" href="https://t.me/lnv111">в Telegram</a>
                <a class="banner__social banner__social_whatsapp" href="https://wa.me/+79156257342">в WhatsApp</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="service__wrap">
            <div class="service__left">
                <div class="service__title">
                    <span>Рассчитайте примерный заработок с каждой услуги</span>
                </div>

                <div class="service__subtitle">Сервис для всех услуг</div>
                <ul class="service__sublist">
                    <li class="service__subitem">Удержание клиента и сопровождение сделки</li>
                    <li class="service__subitem">Юридическая поддержка для вас и клиента</li>
                    <li class="service__subitem">Доставляем полис и результаты отчетов на дом</li>
                    <li class="service__subitem">Независимая экспертиза</li>
                    <li class="service__subitem">Расчет стоимости каждой услуги</li>
                    <li class="service__subitem">Бесплатные услуги и скидки в СТО</li>
                </ul>
            </div>
            ...
            <div class="service__right">
                ...
                <div class="service__list">
                        ...
                        <div class="service__inner" data-sum="0.7">
                            ...
                            <div class="service__sum">
                                ...
                                <div class="service__box">
                                    <button class="service__btn service__btn_plus"><span></span><span></span></button>
                                    <div class="service__input">
                                        <div contenteditable="true">10 000 000</div>
                                    </div>
                            ...
                            <div class="service__commission">
                                <div class="service__descr">Комиссия</div>
                                <div class="service__price">~ <span>25 000</span> ₽</div>
                            </div>
                        </div>

                        <div class="service__bottom">
                            <div class="service__bottom-box">
                                <div class="service__bottom-title">Банки-партнеры</div>
                                <div class="service__bottom-list">
                                    <button class="service__slider-btn service__slider-btn_prev"></button>
                                    <button class="service__slider-btn service__slider-btn_next"></button>
                                    <div class="service__slider">
                    ...
                    <div class="service__item service__item_box-2" style="display: none">
                        <div class="service__inner" data-sum="40">
                            <div class="service__caption">Вы заработаете до 40%:</div>
                            <div class="service__sum">
                                <div class="service__descr">Сумма сделки</div>
                                <div class="service__box">
                                    <button class="service__btn service__btn_plus"><span></span><span></span></button>
                                    <div class="service__input">
                                        <div contenteditable="true">5 000</div>
                                    </div>
                                    <button class="service__btn service__btn_minus"><span></span></button>
                                </div>
                            </div>
                            ...
                            <div class="service__commission">
                                <div class="service__descr">Комиссия</div>
                                <div class="service__price">~ <span>2 000</span> ₽</div>
                            </div>
                        </div>
                    </div>

                    <div class="service__item service__item_box-3" style="display: none">
                        <div class="service__inner" data-sum="10">
                            ...
                            <div class="service__sum">
                                ...
                                <div class="service__box">
                                    <button class="service__btn service__btn_plus"><span></span><span></span></button>
                                    <div class="service__input">
                                        <div contenteditable="true">60 000</div>
                                    </div>
                                    <button class="service__btn service__btn_minus"><span></span></button>
                                </div>
                            </div>
                            ...
                            <div class="service__commission">
                                <div class="service__descr">Комиссия</div>
                                <div class="service__price">~ <span>6 000</span> ₽</div>
                            </div>
                        </div>
...
<section class="advantages">
    <div class="container">
        ...
        <div class="advantages__wrap advantages__wrap_box-3">
            <div class="advantages__info">
...
<section class="cooperation">
    <div class="container">
        <div class="cooperation__title">Процесс сотрудничества</div>
        <div class="cooperation__list">
            ...
            <div class="cooperation__item cooperation__item_box-3">
                ...
                <div class="cooperation__text">Куратор делает расчет и готовит договор</div>
            </div>
        ...
        <button class="cooperation__btn callback">Стать партнером</button>
    </div>
</section>
            ...
            <div class="personal__info">
                ...
                <div class="personal__list">
                    <div class="personal__item">
                        <div class="personal__subtitle">Мобильность</div>
                        <p>Мгновенно оставляйте заявки на новые сделки с разных устройств</p>
                    </div>
                    <div class="personal__item">
                        <div class="personal__subtitle">Отслеживайте статус</div>
                        <p>Следите за статусом сделок в режиме реального времени</p>
                    </div>
                    <div class="personal__item">
                        <div class="personal__subtitle">Учет сделок</div>
                        <p>Все сделки сохраняются в одном месте</p>
                    </div>
                    <div class="personal__item">
                        <div class="personal__subtitle">Стабильность</div>
                        <p>Проведите аналитику и планируйте заработок</p>
                    </div>
                </div>
        ...
        <div class="questions__wrap">
            ...
            <div class="questions__list">
                <details class="questions__item">
                    <summary>
                        <div class="questions__subtitle">
                            <span>В чем выгода от работы по партнерской программе?</span>
                        </div>
                    </summary>
                ...
                <details class="questions__item">
                    <summary>
                        <div class="questions__subtitle">
                            <span> В чем выгода клиента при работе через риелтора/агентство по партнерской программе? </span>
                        </div>
                    </summary>
                    <p class="questions__text">
                ...
                <details class="questions__item">
                    <summary>
                        <div class="questions__subtitle">
                            <span>В чём отличие по разным страховым компаниям?</span>
                        </div>
                    </summary>
                    <p class="questions__text">
                ...
                <details class="questions__item">
                    <summary>
                        <div class="questions__subtitle">
                            <span>Какие документы нужны для предварительного расчета/консультации?</span>
                        </div>
                    </summary>
                    <p class="questions__text">
                        Никакие документы не требуются. Для осуществления предварительного расчета необходимо знать:
                    </p>
                    <ul class="questions__sublist">
                        <li class="questions__subitem">Наименование банка</li>
                        <li class="questions__subitem">Пол и дата рождения заемщика</li>
                        <li class="questions__subitem">
                            Фактический остаток на данный момент (сколько планируется брать в ипотеку)
                        </li>
                    </ul>
                </details>
                <details class="questions__item">
                    <summary>
                        <div class="questions__subtitle">
                            <span>Возможно ли сделать оценку по фото? Для каких регионов?</span>
                        </div>
                    </summary>
                    <p class="questions__text">
        ...
        <div class="footer__top">
            ...
            <div class="footer__right">
                ...
                <div class="footer__contacts">
                    ...
                    <div class="footer__contacts-item">
                        <a class="footer__contacts-link" href="tel:84956600098">+7 495 660-00-98</a>
                        <p class="footer__contacts-text">Москва</p>
                    </div>
                </div>

                <button class="footer__right-btn callback">Обратный звонок</button>
            </div>
        </div>
