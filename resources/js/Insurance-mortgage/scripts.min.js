...
jQuery(document).ready(function ($) {
  ...
  $('.js__calcLead').click(function () {
    $('#leadCreditSum').val(parseInt($('.js__calcSum').val()).toLocaleString('ru-RU', {
  ...
  $(document).on('click', '.goal__callback_form_open', function () {
    try {
      yaCounter54078988.reachGoal('callback_form_open');
    } catch (e) {}
  });
  $(document).on('click', '.goal__lead_form_open', function () {
    try {
      yaCounter54078988.reachGoal('lead_form_open');
    } catch (e) {}
  });
  $(document).on('click', '#callBack-send-button', function () {
    ...
    $.ajax({
      ...
      success: function success(result) {
        ...
        try {
          yaCounter54078988.reachGoal('lead_form_submit');
        } catch (e) {}
      },
  ...
  $(document).on('click', '.callback_button', function () {
    ...
    $.ajax({
      ...
      success: function success(result) {
        ...
        try {
          yaCounter54078988.reachGoal('callback_form_submit');
        } catch (e) {}
      },
      error: function error(jqXHR, textStatus, errorThrown) {
        console.log(jqXHR, textStatus, errorThrown);
...
function calculate() {
  ...
  home = sum * 0.1 / 100;
  home = home * 0.95;
  var homeText = home.toLocaleString('ru-RU', {
    maximumFractionDigits: 0
  });
  var titulText = titul.toLocaleString('ru-RU', {
    maximumFractionDigits: 0
  }); // $('.re-result .price').text(homeText + ' ₽');

  $('.re-result .price').html(homeText + ' <i class="fa fa-rub"></i>'); // $('.titul-result .price').text(titulText + ' ₽');
  ...
  try {
    yaCounter54078988.reachGoal('calc_calculate');
  } catch (e) {}
}
...
/***/ 3:
/*!*****************************************************************************************************************************************************************************************************************************************!*\
  !*** multi ./public/libs/jquery/dist/jquery.min.js ./public/libs/vue/vue.js ./public/libs/slick/slick.min.js ./public/libs/fancybox/jquery.fancybox.pack.js ./public/libs/mask/mask.js ./public/js/Insurance-mortgage/custom/common.js ***!
  \*****************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! c:\Users\gerratresher\Documents\date\OpenServer\domains\fw\public\libs\jquery\dist\jquery.min.js */"./public/libs/jquery/dist/jquery.min.js");
__webpack_require__(/*! c:\Users\gerratresher\Documents\date\OpenServer\domains\fw\public\libs\vue\vue.js */"./public/libs/vue/vue.js");
__webpack_require__(/*! c:\Users\gerratresher\Documents\date\OpenServer\domains\fw\public\libs\slick\slick.min.js */"./public/libs/slick/slick.min.js");
__webpack_require__(/*! c:\Users\gerratresher\Documents\date\OpenServer\domains\fw\public\libs\fancybox\jquery.fancybox.pack.js */"./public/libs/fancybox/jquery.fancybox.pack.js");
__webpack_require__(/*! c:\Users\gerratresher\Documents\date\OpenServer\domains\fw\public\libs\mask\mask.js */"./public/libs/mask/mask.js");
module.exports = __webpack_require__(/*! c:\Users\gerratresher\Documents\date\OpenServer\domains\fw\public\js\Insurance-mortgage\custom\common.js */"./public/js/Insurance-mortgage/custom/common.js");
